...
public class CnfgAdicional extends AppCompatActivity{
    ...
    public void guardarAlertas(View view) {
        Intent intent = new Intent(this, HistorialAlerta.class);
        startActivity(intent);
    }
    ...
    public void registroDePago(View view) {
        Intent intent = new Intent(this, RegistroPago.class);
        startActivity(intent);
    }
}
